...
-- 3. Função para criar perfil automaticamente no cadastro
...
-- 10. Políticas de Acesso (Permitir leitura/escrita para usuários logados)
DO $$ 
DECLARE
    t text;
BEGIN
