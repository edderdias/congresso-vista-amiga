                      ...
                      <div className="space-y-3">
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="flex justify-between items-center bg-amber-50/50 p-2 rounded border border-amber-100">
                            ...
                            <span className="text-sm font-bold">{getPubName(findDesig(selectedEvent.school_assignments, "Leitura da Bíblia")?.user_id || selectedEvent.school?.find((s:any) => s.part_type === "Leitura da Bíblia")?.student_id)}</span>
                          </div>
                        </div>
                      </div>
